...
import com.reszkojr.springloginlearning.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String content = buildEmail(request.getFirstName(), "http://localhost:8080/api/v1/registration/confirm?token=" + token);
        emailSender.send(request.getEmail(), content);
